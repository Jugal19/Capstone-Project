<?php
    ...
    else
    {
        ...
        pg_query(db_connect(), "INSERT INTO monthly_enewsletter (client_first_name, 
...
<div style="margin-left:auto; margin-right:auto;">
        <button onclick="location.href='./monthly_enewsletter.php'" 
            type="button">Close Main Client Birthday Form</button>
        <br>
        <br>
